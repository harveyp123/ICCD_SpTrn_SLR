...
def parse_args_dense():
    ...
    parser.add_argument('--input-size', type=int, default=64,
                        help="Input size")
    parser.add_argument('--hidden1-size', type=int, default=256,
                        help="Hidden dimension size")
    parser.add_argument('--hidden2-size', type=int, default=128,
                        help="Hidden dimension size")
    ...
    parser.add_argument('--running-dir', default='/home/hop20001/ADMM_SLR_GNN_Node_class', help='Running directory')
    parser.add_argument('--dataset', default='brain_dense', help='Dataset name')
    parser.add_argument('--model-name', default='brain_dense', help='Stored model name')
    parser.add_argument('--log-name', default='brain_dense_train', help='Log file name')
...
def parse_args_admm():
    ...
    parser.add_argument('--sparsity', type=float, default=8/128,
                        help="Layer sparsity")
    ...
    parser.add_argument('--gpus', default='3', help='gpu device ids separated by comma. '
                        '`all` indicates use all gpus.')
    parser.add_argument('--load-model', default='brain_dense_HID128.ckpt', help='load model name')         
    parser.add_argument('--log-name', default='brain_dense_admm', help='Log file name')
    ...
    args.logging = args.running_dir + '/log/' + args.dataset + '/' + args.log_name + '_Spa_' \
                                    + str(args.sparsity) + '.log'
...
#       exit()
    ...
    args.input_size = 64
    args.hidden1_size = 256
    args.hidden2_size = 128
    args.num_classes = 10
    # args.epochs = 50
    # args.epochs = 1
